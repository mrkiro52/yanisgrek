...
export default function Discounts() {
  const discounts = [
    {
      id: 1,
      title: "Скидка 50% работы на тех. обслуживание (ТО) при покупке фильтров и масла*",
      description: "Акция действует до 31.12.2025. Подробности акции уточняйте у менеджеров Технического центра!",
      image: "/images/banner1.png"
    },
    {
      id: 2,
      title: "Скидка 30% на замену тормозной жидкости*",
      description: "Акция действует до 31.12.2025. Подробности акции уточняйте у менеджеров Технического центра!",
