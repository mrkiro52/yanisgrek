    ...
    <div className="About">
      ...
      <div className="block_about">
        <div className="block_about_photo_text">
          ...
          <img src="/images/photo_block_about.jpg" alt="Интерьер техцентра YANIS GREK с профессиональным оборудованием" loading="lazy"/>
        </div>
      </div>
      <TeamBlock/>
      ...
      <div className="block_about_from_founder">
        ...
        <div className="row_1_description_photo">
          ...
          <img src="/images/photo_office.jpg" alt="" loading="lazy"/>
        </div>
