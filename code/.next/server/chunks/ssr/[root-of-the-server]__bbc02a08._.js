...
async function Car({ params }) {
    const { model } = params;
    // Загрузка данных API с кэшированием на 60 секунд
    ...
    if (!modelsRes.ok || !submodelsRes.ok || !seriesRes.ok || !servicesRes.ok) {
    ...
    // Чтение информации о машине из JSON-файла (SSG)
    ...
    const json = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(filePath, 'utf-8');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bbc02a08._.js.map