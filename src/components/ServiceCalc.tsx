...
export default function ServiceCalc() {
  ...
  const getCarImage = (fileName: string) => {
    const imageMap: { [key: string]: string } = {
      'bmw-1': 'https://s3.regru.cloud/yanis-grek/cars/bmw-1.webp',
      'bmw-2': 'https://s3.regru.cloud/yanis-grek/cars/bmw-2.webp',
      'bmw-3': 'https://s3.regru.cloud/yanis-grek/cars/bmw-3.webp',
      'bmw-4': 'https://s3.regru.cloud/yanis-grek/cars/bmw-4.webp',
      'bmw-5': 'https://s3.regru.cloud/yanis-grek/cars/bmw-5.webp',
      'bmw-6': 'https://s3.regru.cloud/yanis-grek/cars/bmw-6.webp',
      'bmw-7': 'https://s3.regru.cloud/yanis-grek/cars/bmw-7.webp',
      'bmw-8': 'https://s3.regru.cloud/yanis-grek/cars/bmw-8.webp',
      'bmw-x': 'https://s3.regru.cloud/yanis-grek/cars/bmw-x.webp',
      'bmw-m': 'https://s3.regru.cloud/yanis-grek/cars/bmw-m.webp',
      'bmw-i': 'https://s3.regru.cloud/yanis-grek/cars/bmw-i.webp',
      'bmw-z': 'https://s3.regru.cloud/yanis-grek/cars/bmw-z.webp',
      'mini-cooper': 'https://s3.regru.cloud/yanis-grek/cars/mini-cooper.webp',
      'rolls-royce': 'https://s3.regru.cloud/yanis-grek/cars/rolls-royce.webp'
    };
