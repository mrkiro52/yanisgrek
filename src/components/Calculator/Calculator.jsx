        ...
        <div className="Calculator">
            <div className="choose_model">
                <div className="title_row">
                    ...
                    {subId === null ?
                        <span className='red'>Выберите модель</span> : <Link href={`/cars/bmw-${sub.name.toLowerCase()}`} className='black'>Страница BMW {sub.name}</Link>
                    }
                </div>
                ...
                {filteredServices.map((s, index) => {
                    ...
                    return (
                        <div className="calculator_table__row" key={index}>
                            ...
                            <div className="calculator_table__cell">{Number(s.part_price).toLocaleString()}</div>
                            <div className="calculator_table__cell">{Number(s.labor_price).toLocaleString()}</div>
                            <div className="calculator_table__cell">{total.toLocaleString()}</div>
                        </div>
                    );
                })}
