...
export default function ContactsPage() {
  ...
  // Убрана аннотация типа для корректного парсинга
  const handleSubmit = (e) => {
    ...
    const message =
      ...
      `Дата: ${date} ${time}`;
    const whatsappURL =
      `https://wa.me/79852707575?text=${encodeURIComponent(message)}`;
        ...
        <div className="ContactFormSection">
          ...
          <div className="contacts-info">
            <div className="contacts-info-block">
              ...
              <a href="https://yandex.ru/profile/1175654222?lang=ru" target="_blank">
                г. Москва
                <br />
